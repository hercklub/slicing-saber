...
namespace Framewerk.UI.List
{
    ...
    public class ListBaseMediator<TView, TData> : ExtendedMediator, IListMediator<TData> where TView : ListView 
                                                                                              ...
                                                                                              
    {
        ...
        protected virtual GameObject CreateItemMediator(int index, GameObject prefab, Transform parent)
        {
